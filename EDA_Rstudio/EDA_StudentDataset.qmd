...
```{python}
compare = pd.DataFrame({'Model': ['ZeroR', 'OneR', 'Random Forests', 'K Neighbors', 'SVM', 'DecisionTreeRegressor', 'SVR', 'RandomForestRegressor', 'KNeighborsRegressor'], 
                        'Accuracy': [8.86, 16.45, accRandFor, KNAcc*100, SVCAcc*100, 0.81, 0.87, 0.88, 0.84]})
